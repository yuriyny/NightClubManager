...
//	private TextField passwordFld;
	...
	public NewBartenderInfo(PeopleBag pBag, Manager m){
		...
		saveBtn.setOnAction(e->{
			...
			Bartender b = new Bartender(fname,lname,phone,a,"login","password",salary,eb);//null for login/password
