...
//	private TextField passwordFld;
	...
	public BartenderDetails(PeopleBag pBag, Manager m, Bartender bartender){
...
//		gPane3.add(passwordFld, 1, 1);
		fNameFld.setText(bartender.getfName());
		lNameFld.setText(bartender.getlName());
		phoneFld.setText(bartender.getPhone());
		stNameFld.setText(bartender.getAddress().getStName());
		stNumberFld.setText(bartender.getAddress().getStNumber());
		cityFld.setText(bartender.getAddress().getCity());
		stateFld.setText(bartender.getAddress().getState());
		zipFld.setText(bartender.getAddress().getZip());
		salaryFld.setText(bartender.getSalary());
...
//			passwordFld.setEditable(true);
		...
		saveBtn.setOnAction(e->{
			...
			bartender.setfName(fname);
			bartender.setlName(lname);
			bartender.setPhone(phone);
			bartender.setAddress(a);
			bartender.setSalary(salary);
			pBag.save();
