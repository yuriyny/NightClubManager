...
//	private TextField passwordFld;
	...
	public CkDetails(PeopleBag pBag, Manager m, Cook cook){
...
//		gPane3.add(passwordFld, 1, 1);
		fNameFld.setText(cook.getfName());
		lNameFld.setText(cook.getlName());
		phoneFld.setText(cook.getPhone());
		stNameFld.setText(cook.getAddress().getStName());
		stNumberFld.setText(cook.getAddress().getStNumber());
		cityFld.setText(cook.getAddress().getCity());
		stateFld.setText(cook.getAddress().getState());
		zipFld.setText(cook.getAddress().getZip());
		salaryFld.setText(cook.getSalary());
