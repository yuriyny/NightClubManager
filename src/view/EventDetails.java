...
public class EventDetails {
	...
	public EventDetails(ClubEvent e){
		...
		priceLbl = new Label("Ticket Price:");
		...
		gPane.add(priceLbl, 0, 4);
		gPane.add(priceFld, 1, 4);
		gPane.add(tableLbl, 0, 5);
		gPane.add(tableFld, 1, 5);
		gPane.add(wineLbl, 0, 6);
		gPane.add(wineFld, 1, 6);
		gPane.add(chamLbl, 0, 7);
		gPane.add(chamFld, 1, 7);
		gPane.add(vodkaLbl, 0, 8);
		gPane.add(vodkaFld, 1, 8);
		gPane.add(sodaLbl, 0, 9);
		gPane.add(sodaFld, 1, 9);
		...
		mPane.getChildren().addAll(gPane, buttonPane);
